...
Over the last decade, several significant steps have been made toward overcoming the challenges in finding the structure of \gls{tmp}s.
Firstly, improvements in expression and purification occured thanks to cleavable green fluorescent protein (allowing protein tracking during purification) \cite{Drew2005, Kawate2006} and antibody tagging for purification \cite{Eshagi2005} at the colony level \cite{Cornvik2005}.
...
The technology behind nanodiscs was originally published in 2002 \cite{Bayburt2002}, and was shown to be a viable method for obtaining native conditions for \gls{tmp}s a couple of years later for cytochrome P450 \cite{Duan2004}.
...
However, critical questions remain: How is the \gls{tmh} oriented in the membrane, how is the \gls{tmh} interacting with the membrane, how is the \gls{tmh} interacting with another \gls{tmh} in the membrane, does the \gls{tmh} have functions beyond anchoring and if so what are they?
