...
\section{$\protect\alpha$ Helices; Structure And Function}
...
The Kyte \& Doolittle used evidence from previous experiments in the literature scaling them between -4.5 and +4.5.
...
\section{$\protect\beta$ sheets in the membrane}
...
In chapter 4 we look at families of \gls{tmp} that exhibit high hydrophobic discrepency between sequentially adjacent \gls{tmh}s.
The conservation of these pairs across the families corroborates evidence of cooperative \gls{tmh} insertion, showing that marginally hydrophobic \gls{tmh}s could use typical \gls{tmh}s as part of their biogenesis.
