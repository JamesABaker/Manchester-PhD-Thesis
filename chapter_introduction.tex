...
One problem in biological membranes is that the compartments always  involve multiple ion channels.
...
However, there needs to be flux of not only molecules, but signals across these membranes in order to facillitate cellular life.
Both $\beta$ sheets and $\alpha$ helices are capable of traversing the membrane space.
The focus of this thesis is primarily on \gls{tmh}s, however, $\beta$ sheets are another protein structure capable of spanning the membrane.
...
Their restriction to these membrane types is the result of ancestral symbiogenesis \cite{Fischer1994, Zeth2010, Fairman2011, Ulrich2015}.
These outer membrane proteins cause the membranes to be permeable, diminishing membrane potential between the outer and the inner membrane (Figure \ref{fig:barrel-versus-helix}).
Unlike the \gls{tmh}s, $\beta$ barrel proteins are permeable to water and many other small molecules.
...
Phenylalanine, although aromatic, is completely hydrophobic, and is found in the transmembrane part rather than the interfacial parts of MPs.
...
\subsection{Hydrophobicity of transmembrane Segments}\label{ssection:hydrophobicityscales}
...
The z-score is a product of both hydrophobicity and a Shannon like sequence entropy of the character string in the~\gls{tmh}. This term is described below in equation~\ref{equation:zscoreterm}.
...
\subsection{Bioinformatics in transmembrane biology}
...
SecYEG targets proteins to the \gls{pm} (inner membrane) of bacteria and Sec61 targets proteins to the \gls{er} of eukaryotic cells.
