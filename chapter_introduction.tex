...
Simply put, membrane potential is the voltage across a membrane. If the membrane is permeable to a certain type of ion, then the ion will experience an electrical pulling force during the diffusion process that will facour the ``preferred'' biological location.

There are various ways of estimating the membrane potential {\it ab initio}. There are two famous equations that are often discussed when estimating this voltage. The Nernst equation is derived directly from the simplified thermodynamic principles (i) the Boltzmann ditribution, and (ii) the 
