...
In a laboratory experiment \gls{tmp}s typically present several challenges for studying them \cite{Seddon2004}.
...
In addition to the difficulties in studying \gls{tmp}s, it has become clear that they have a rich structural diversity.
...
\gls{tmh}s share composition similarities due to membrane requirements and restraints, not necessarily due to common ancestry which underpins homology\--based domain libraries like Pfam \cite{Finn2016} and SMART \cite{Letunic2012}.
