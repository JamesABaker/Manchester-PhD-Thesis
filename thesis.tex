...
We identify different amino acid distributions in anchoring helices compared to transmembrane helices with function beyond anchoring that would allow anchroing transmembrane helices to stabilise more effectively in the membrane.
We show adaptations of residue distributions through the transmembrane helices of tail\--anchored proteins to different membrane environments.
Structural modeeling well as a 3D amphipathic arrangement of residues of spontaneously inserting transmembrane helices that may be responsible for their insertion.
...
Hopefully, these findings will provide some insight into the workings of some genetic diseases as well as drug targets in the case of pathogenic infections and cancers.
