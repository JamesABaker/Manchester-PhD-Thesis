...
\usepackage[backend=biber,style=nature,citestyle=nature]{biblatex} %science, nature, alphabetic are common choices.
...
%This is where we call the chapters. No need to include ".tex"
