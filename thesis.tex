...
In this thesis I make the argument that there are different classifications of trans-membrane $\alpha$ helices. These have markedly different evolutionary pressures, different classes interact differently with the membrane, and serve the protein differently.
