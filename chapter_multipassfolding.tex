...
In the 6TMH class of ion channels, we observe a conserved difference in the relatively polar TMH4 known to carry charged residues.
...
This holds true for voltage gated ion channels, ligand gated ion channels, and appears to be independent of the ion being transported (Calcium or Potassium).

The difference is independent of the scale chosen (Figure \ref{fig:ion-channel-hydrophobicity-verification}).

\begin{figure}[!ht]
\centering
\includegraphics[width=1\textwidth]{multipass-folding/ion-channel-hydrophobicity-verification}
  \captionof{figure}[The hydrophobic difference observed between TMH4 and it's neighboring TMHs in 6TMH ion channels is not due to the choice of hydrophobic scale.]{\textbf{The hydrophobic difference observed between TMH4 and it's neighboring TMHs in 6TMH ion channels is not due to the choice of hydrophobic scale.}
...
24TMH class is essentially a modular variant of the 6TMH class, and has even more extreme discrepencies between the equivalent 4 TMHs.

This is another example of cooperative \gls{tmh} insertion.
The 3rd and 4th \gls{tmh} of the potassium channel (shaker family) was shown to insert either sequentially or cooperatively \cite{Zhang2007, Cymer2015}.
...
This is due to the other component of the z-score, the sequence information entropy.
