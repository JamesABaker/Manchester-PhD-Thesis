...
\includegraphics[width=0.8\textwidth]{multipass-folding/other-groups-good-bad}
		\captionof{figure}[High polarity discrepency between sequentially adjancent TMHs is not present in all TMP transporter families.]{\textbf{High polarity discrepency between sequentially adjancent TMHs is not present in all TMP transporter families.}
